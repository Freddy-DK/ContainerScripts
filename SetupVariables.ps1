...
Write-Host "BakFile: $env:bakfile"
Write-Host "Database Server: $env:databaseServer"
Write-Host "Database Instance: $env:databaseInstance"
Write-Host "Database Name: $env:databaseName"
...
Write-Host "BakFile: $bakfile"
Write-Host "Database Server: $databaseServer"
Write-Host "Database Instance: $databaseInstance"
